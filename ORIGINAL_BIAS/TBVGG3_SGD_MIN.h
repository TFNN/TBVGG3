...
--------------------------------------------------
    ...
    Network size:
        (3x28x28)+(8x3x9)+(16x8x9)+(32x16x9)+(8x28x28)+
        (8x14x14)+(16x14x14)+(16x7x7)+(32x7x7)+(8x28x28)+
        (16x14x14)+(32x7x7)+(8+16+32)+(8+16+32) = 32,744 floats
        32744*4 = 130,976 bytes = 0.130976 megabytes
*/
