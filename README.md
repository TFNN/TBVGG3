...
The dataset used in the example provided [main.c] is [CSGO.zip](https://github.com/TFCNN/DOCS/raw/main/DATASETS/CSGO.zip) from [DOCS/DATASETS](https://github.com/TFCNN/DOCS/tree/main/DATASETS).
